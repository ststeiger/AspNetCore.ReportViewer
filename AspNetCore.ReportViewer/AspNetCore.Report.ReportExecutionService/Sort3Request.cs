...
namespace AspNetCore.Report.ReportExecutionService
{
	...
	[MessageContract(WrapperName = "Sort3", WrapperNamespace = "http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices", IsWrapped = true)]
	public class Sort3Request
	{
